...
Run the program on GPU using:
```
SYCL_DEVICE_FILTER=opencl:gpu make run
or,
SYCL_DEVICE_FILTER=opencl:gpu ./histogram
```
Run the program on CPU usting:
```
SYCL_DEVICE_FILTER=opencl:cpu make run
or,
SYCL_DEVICE_FILTER=opencl:cpu ./histogram
```
